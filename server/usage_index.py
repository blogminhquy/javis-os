...
# Grok Build CLI (goi SuperGrok / X Premium+). Cot rieng, cung ly do nhu Gemini CLI o tren:
# day la duong THUE BAO, khong phai tra tien theo luot goi nhu mot API key xAI.
