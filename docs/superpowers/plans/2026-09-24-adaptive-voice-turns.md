...
- [ ] Independent branch review, fix important findings with regression tests, merge only green exact head, tag/release 0.64.35 after main CI and matching GHCR image.
