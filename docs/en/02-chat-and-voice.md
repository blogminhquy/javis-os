...
After selecting a provider, save the setting. If the selected voice fails, Javis reports the error so you can retry or select another voice. It does not switch voices automatically.
